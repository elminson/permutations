...
class PermutationsTest extends TestCase
{
	public function testPermutations()
	{
		...
		$permutationsResult = Permutations::generate([$array, $array2], $includeOriginalArray);
		...
		$permutationsResult = Permutations::generate([$array3, $array4]);
		$this->assertEquals($permutations, $permutationsResult);
		...
		$permutationsElements = Permutations::generate([$array7, $array8]);
		$this->assertEquals($permutationsExpected, $permutationsElements);
